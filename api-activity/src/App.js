...
const App = (props) => {
  ...
  function getAllCharacter(){
    fetch(baseUrl+'people').then((result) => result.json()).then((res) => console.log(res))
  
  }

  function getCharacter(){
    fetch(baseUrl+'people/1').then((result) => result.json()).then((res) => console.log(res))
  }
  ...
  function getCharacterFilmByUrl(){
    fetch(baseUrl+'films').then((result) => result.json()).then((res) => console.log(res))

  }
  function getCharacterSpeiceByUrl(){
    fetch(baseUrl+'species').then((result) => result.json()).then((res) => console.log(res))

  }
  function getCharacterStarshipsByUrl(){
    fetch(baseUrl+'starships').then((result) => result.json()).then((res) => console.log(res))

  }

  function getCharacterVehiclesByUrl(){
    fetch(baseUrl+'vehicles').then((result) => result.json()).then((res) => console.log(res))
    
  }
  useEffect(() => {
    getAllCharacter();
    getCharacter();
    getCharacterFilmByUrl();
    getCharacterSpeiceByUrl();
    getCharacterStarshipsByUrl();
    getCharacterVehiclesByUrl();
